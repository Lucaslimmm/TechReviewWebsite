    ...
    <body class="fixed-left">
        ...
        <div id="wrapper">
            ...
            <div class="topbar">
                ...
                <!-- Button review view to collapse sidebar menu -->
            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">review Dashboard</h4>
                        ...
                        <div class="row">
                        <a href="review-manage-categories.php">
...
<?php $query=mysqli_query($con,"select * from reviewcategory where Is_Active=1");
