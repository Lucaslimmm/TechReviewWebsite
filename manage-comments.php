											...
											<div class="demo-box m-t-20">
												...
												<div class="table-responsive">
                                                    <table class="table m-0 table-colored-bordered table-bordered-primary">
                                                        ...
                                                        <tbody>
<?php 
$query=mysqli_query($con,"Select tblcomments.id,  tblcomments.name,tblcomments.postingDate,tblcomments.comment,reviewpost.id as postid,reviewpost.PostTitle from  tblcomments join reviewpost on reviewpost.id=tblcomments.postId where tblcomments.status=1");
$cnt=1;
